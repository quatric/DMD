...
### 🪟 Windows Users
1.  Go to the **[Release](https://github.com/TheRealMrDjango/DMD/releases/tag/v0.2.5.1_windows)** page.
2.  Download `DMD.exe`.
3.  Run the application directly.

### 🍎 macOS Users
1.  Go to the **[Release](https://github.com/TheRealMrDjango/DMD/releases/tag/v0.2.5.1_macOS)** page.
2.  Download `DMD.app` (zipped).
3.  Unzip and run the application.
    * *Note: You may need to allow the app in System Settings > Privacy & Security if it is not signed.*
